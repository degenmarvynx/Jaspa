      ...
      <Container>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
          <div className="relative">
            <div className="absolute -left-[400px] -top-[400px] md:-left-[400px] md:-top-[400px] w-[800px] h-[800px] rounded-full border-[40px] border-[#df2202] pointer-events-none z-0" />
          ...
          <div className="max-w-[600px] md:h-[440px] flex flex-col justify-center">
            <h3 className="text-[#044ea4] font-extrabold text-[28px] md:text-[40px] leading-[1.15] text-right">
              Partnerships
              <br />&amp; Referrals
            </h3>
            <p className="mt-4 text-right text-[#012e6d] text-[14px] md:text-[18px] leading-[24px] md:leading-[30px]">
