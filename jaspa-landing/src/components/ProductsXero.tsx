    ...
    <section className="py-12 md:py-16">
      <Container>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
          <div className="order-1 max-w-[525px]">
            <h3 className="text-[#044ea4] font-extrabold text-[30px] md:text-[44px] leading-[1.1] text-center md:text-left">
              Xero
              <br />
              Accounting
              <br />
          ...
          <div className="order-2 relative w-[320px] h-[320px] md:w-[480px] md:h-[480px] rounded-[30px] border-[5px] border-[#df2202] overflow-hidden mx-auto">
